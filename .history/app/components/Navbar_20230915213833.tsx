              ...
              <Link
                ...
                className={`${
                  pathname === "/"
                    ...
                    : "border-transparent text-gray-500 hover:bg-gray-50 hover:border-gray-300 hover:text-white block pl-3 pr-4 py-2 dark:hover:bg-gray-700"
                }`}
              >
                HOME
              </Link>
            ...
            <div className="pt-2 pb-3 space-y-1">
              <Link
                ...
                className={`${
                  pathname === "/feedback"
                    ? "bg-blue-50 border-blue-500 text-blue-500 block pl-3 pr-4 py-2 border-l-4 text-base font-medium dark:bg-gray-800"
                    : "border-transparent text-gray-500 hover:bg-gray-50 hover:border-gray-300 hover:text-white block pl-3 pr-4 py-1  dark:hover:bg-gray-700 border-l-4 text-base font-medium dark:text-white"
                }`}
              >
                Feedback
              </Link>
