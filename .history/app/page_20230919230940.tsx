    ...
    <div className="divide-y divide-gray-100 dark:divide-gray-700">
      ...
      <div className="items-center space-y-2 xl:grid xl:grid-cols-3 xl:gap-x-8 xl:space-y-0">
        ...
        <div className="prose max-w-none prose-lg pt-8 pb-7 leading-loose dark:prose-invert xl:col-span-2">
          ...
          <p>
          I'm a budding magician in the world of web development, and I'm passionate about crafting web experiences that are not only functional but also visually appealing. I'm currently honing my skills in JavaScript and CSS, and I'm excited about the journey ahead. 🌐✨
          </p>
          <p>
