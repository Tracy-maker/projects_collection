...
<p>
  Motivated and detail-oriented Full Stack Developer with 5+ years of extensive experience in front-end and back-end web application development. Proficient in TypeScript (React), AWS and Node.js. Highly skilled in building secure, scalable, and reliable code across various platforms. Passionate about software development with significant expertise in JavaScript frameworks, CI/CD, TDD and Cloud technologies. Demonstrated success in agile development environments, consistently delivering projects on time.
</p>
<p>
